<!DOCTYPE html>
  ...
  <body>
          ...
          <div class="container">
            <div class="row">
              ...
              <div class="col-lg-10">
                ...
                <a href="course.php" class="cp">Course</a>
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-12 col-sm-12">
            <div class="employee_info" style="padding-top: 30px;">
              ...
              <form class="ui form" method=get action=course_insert_handler.php>
                  ...
                  Image Link: <input type="text" name="Course_Image"> <br>
    ...
    <div class="course_info" style=" padding-bottom: 25px;">
    <?php
        ...
        ?>
                ...
                <h1 style=" margin-left: 260px;">Course Information</h1>
        
                <div class="ui text container">

            <?php
                echo "<table class='ui table'> \n";
                echo "<thead><th>Course ID</th> <th>Course Name</th> <th>Department</th> <th>Image Link</th> <th>Option</th> <th>Update</th></thead> \n";
                ...
                while( $rows = mysqli_fetch_array( $results ) ) {
                    ...
                    echo "<td> $Course_Image </td>";
                  
                    echo "<td> <a style='color: red;' href='course_delete.php?id=$Course_ID'>Delete</a> </td>";
                    echo "<td> <a style='color: blue;' href='course_update.php?id=$Course_ID'>Edit</a> </td>";
                    echo "</tr> \n";
                }
